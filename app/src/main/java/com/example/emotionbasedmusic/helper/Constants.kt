...
class Constants {
    companion object {
        ...
        const val LIKED_SONGS = "likedSongs"
        const val ADDED_LIKED_SONGS = "Added to Liked Songs."
        const val REMOVED_LIKED_SONGS = "Removed from Liked Songs."
        const val NAME_DETAIL = "Enter your name"
        const val PHONE_DETAIL = "Enter your phone number"
